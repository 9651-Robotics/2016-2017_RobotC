...
#pragma config(Motor,  port6,           armRight1,     tmotorServoContinuousRotation, openLoop)
#pragma config(Motor,  port7,           armLeft1,      tmotorServoContinuousRotation, openLoop, reversed)
